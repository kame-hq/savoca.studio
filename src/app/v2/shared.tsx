...
export const VERTICALS = ["Barbershops", "Tattoo Parlors", "Nail Salons", "Med Spas", "Taxidermists", "Contractors", "Photographers", "Goat Yoga Studios", "Landscapers", "Cleaning Companies", "Snake Removal", "Auto Shops", "Detail Shops", "Plumbers", "Mechanical Bull Rentals", "Electricians", "Elvis Impersonators"];
